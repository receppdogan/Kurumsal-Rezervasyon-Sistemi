...
async def create_test_company():
    ...
    company = {
        ...
        "service_fees": {
            ...
            "flight": {"type": "percentage", "value": 5.0, "additional_fee": 25.0, "currency": "USD"},
            "transfer": {"type": "fixed", "value": 25.0, "additional_fee": 0.0, "currency": "TRY"},
            "visa": {"type": "fixed", "value": 100.0, "additional_fee": 0.0, "currency": "EUR"},
            "insurance": {"type": "percentage", "value": 10.0, "additional_fee": 0.0, "currency": "TRY"},
            "car_rental": {"type": "fixed", "value": 40.0, "additional_fee": 15.0, "currency": "USD"}
        },
        "booking_rules": {
            "hotel_max_stars": 5,
